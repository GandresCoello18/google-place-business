    ...
    <LayoutMain>
      ...
      <header className="grid md:grid-cols-3 gap-0">
        <div className="col-span-1">
          <img
            src={getImageBusiness(business?.photos)}
            alt="Imagen 1"
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
          <div className="p-6">
            ...
            <div className="flex items-center mb-3 text-gray-600">
              ...
              >
                ...
                <path
                  fillRule="evenodd"
                  d="M17.293 8.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-8-8a1 1 0 111.414-1.414L10 14.586l6.293-6.293a1 1 0 011.414 0z"
                  clipRule="evenodd"
                />
              </svg>
              <span className="mr-3">Dirección:</span>{' '}
              {loadingBusiness ? (
                <div className="h-4 w-60 mt-4 bg-gray-300 rounded mb-4"></div>
              ) : (
            ...
            <div className="flex items-center mb-3 text-gray-600">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M10 2a8 8 0 100 16 8 8 0 000-16zm0 14a6 6 0 100-12 6 6 0 000 12zm0-9a1 1 0 11-2 0 1 1 0 012 0zm0 4a1 1 0 100-2 1 1 0 000 2z"
                  clipRule="evenodd"
                />
              </svg>
              ...
              {loadingBusiness ? (
                ...
                <p>{business?.primaryTypeDisplayName.text}</p>
              )}
            </div>
            <div className="flex items-center mb-3 text-gray-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="bi bi-browser-chrome w-4 h-4 fill-current mr-2"
                viewBox="0 0 16 16"
              >
                <path
                  fillRule="evenodd"
              ...
              {loadingBusiness ? (
                ...
                <p>
                  {business?.websiteUri ? (
                    <a className="text-blue-500" href={business?.websiteUri} target="_blank">
                      {business?.websiteUri}
                    </a>
                  ) : (
                    '*No especificado*'
            ...
            <div className="flex items-center mb-3 text-gray-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="bi bi-telephone w-4 h-4 fill-current mr-2"
                viewBox="0 0 16 16"
              >
              ...
              {loadingBusiness ? (
                ...
                <p>{business?.internationalPhoneNumber}</p>
              )}
            </div>
            <div className="flex items-center mb-3 text-gray-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="bi bi-truck w-4 h-4 fill-current mr-2"
                viewBox="0 0 16 16"
              >
            ...
            <div className="flex items-center mb-3 text-gray-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="bi bi-table w-4 h-4 fill-current mr-2"
                viewBox="0 0 16 16"
              >
            ...
            <div className="flex items-center mb-3 text-gray-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="bi bi-card-text w-4 h-4 fill-current mr-2"
                viewBox="0 0 16 16"
              >
              ...
              <span>
                Sobre <strong>{business?.displayName?.text}</strong>:
              </span>{' '}
              {loadingBusiness ? (
                <div className="h-4 w-60 mt-4 bg-gray-300 rounded mb-4"></div>
              ) : (
                <p>{business?.editorialSummary?.text || '*No description*'}</p>
              )}
            </div>
            <div className="flex items-center mb-3 text-gray-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="bi bi-person-arms-up w-4 h-4 fill-current mr-2"
                viewBox="0 0 16 16"
              >
            ...
            <div className="flex items-center mb-3 text-gray-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="bi bi-wallet2 w-4 h-4 fill-current mr-2"
                viewBox="0 0 16 16"
              >
                <path d="M12.136.326A1.5 1.5 0 0 1 14 1.78V3h.5A1.5 1.5 0 0 1 16 4.5v9a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 13.5v-9a1.5 1.5 0 0 1 1.432-1.499zM5.562 3H13V1.78a.5.5 0 0 0-.621-.484zM1.5 4a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5z" />
              </svg>
              <p>
                Opciones de pagos: {!business?.paymentOptions && '*No especificado*'}{' '}
                {business?.paymentOptions?.acceptsCashOnly && <Badge text="Efectivo" />}{' '}
                {business?.paymentOptions?.acceptsCreditCards && (
                  <Badge text="Tarjeta de credito" />
                )}{' '}
                {business?.paymentOptions?.acceptsDebitCards && <Badge text="Tarjeta de debito" />}
              </p>
            </div>
            <div className="flex items-center mb-3 text-gray-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="bi bi-star w-4 h-4 fill-current mr-2"
                viewBox="0 0 16 16"
              >
          ...
          <div className="bg-gray-200 p-6">
            ...
            {business?.regularOpeningHours?.weekdayDescriptions ? (
              <OpeningHours
                weekdayDescriptions={business?.regularOpeningHours.weekdayDescriptions}
              />
            ) : (
              '*No especificado*'
            )}
